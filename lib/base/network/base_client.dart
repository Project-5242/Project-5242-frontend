...
class BaseClient {
  static BuildContext? context = Routes.navigatorKey.currentContext;
  ...
  static Future<dynamic> handleRequest(ApiRequest apiRequest) async {
    ...
    if (!isOnline) {
      AppUtils.showToast(message: 'No Internet, Please try later!');
      Navigator.push(
          context!,
          MaterialPageRoute(
  ...
  static Future<String> uploadImage({required String imagePath}) async {
    ...
    return await handleRequest(apiRequest);
  }
}
